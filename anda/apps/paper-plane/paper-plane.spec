...
BuildRequires:	meson cargo terra-gtk4-devel >= 4.10 libadwaita-nightly-devel tdlib-nightly-devel libappstream-glib desktop-file-utils terra-blueprint-compiler
