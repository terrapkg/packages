...
Requires:       sequoia-sqv zenity alsa-lib gtk3 desktop-file-utils openssl nss at-spi2-atk libcurl libSM libayatana-appindicator-glib 
Recommends:     (libavformat.so.61()(64bit) or libavformat.so.60()(64bit) or libavformat.so.58()(64bit))
...
%changelog
* Sat Sep 12 2026 ammix <maxim@ammix.dev> - 0.6.6-3
- Add optional ffmpeg dependency
