...
install -Dm644 peazip-sources/res/share/batch/freedesktop_integration/*.png -t %{buildroot}%{_iconsdir}/hicolor/256x256/apps
...
%{_iconsdir}/hicolor/256x256/apps/peazip*.png
