...
install -Dm755 bin/disk/9mkfs               %{buildroot}%{_bindir}/disk/9mkfs
...
install -Dm755 bin/fossil/9last             %{buildroot}%{_bindir}/fossil/9last
install -Dm755 bin/fossil/9view             %{buildroot}%{_bindir}/fossil/9view
...
install -Dm755 bin/9kill                    %{buildroot}%{_bindir}/9kill
...
install -Dm755 bin/9nroff                   %{buildroot}%{_bindir}/9nroff
...
install -Dm755 bin/9soelim                  %{buildroot}%{_bindir}/9soelim
...
install -Dm755 bin/upas/9msgcat             %{buildroot}%{_bindir}/upas/9msgcat
...
install -Dm755 bin/venti/9read              %{buildroot}%{_bindir}/venti/9read
install -Dm755 bin/venti/ro                 %{buildroot}%{_bindir}/venti/ro
install -Dm755 bin/venti/sync               %{buildroot}%{_bindir}/venti/9sync
install -Dm755 bin/venti/9write             %{buildroot}%{_bindir}/venti/9write
...
install -Dm755 bin/9import                  %{buildroot}%{_bindir}/9import
...
install -Dm755 bin/9basename                %{buildroot}%{_bindir}/9basename
install -Dm755 bin/9bc                      %{buildroot}%{_bindir}/9bc
install -Dm755 bin/9cal                     %{buildroot}%{_bindir}/9cal
...
install -Dm755 bin/9cmp                     %{buildroot}%{_bindir}/9cmp
install -Dm755 bin/9col                     %{buildroot}%{_bindir}/9col
install -Dm755 bin/9comm                    %{buildroot}%{_bindir}/9comm
install -Dm755 bin/core                     %{buildroot}%{_bindir}/core
install -Dm755 bin/9date                    %{buildroot}%{_bindir}/9date
install -Dm755 bin/9dc                      %{buildroot}%{_bindir}/9dc
...
install -Dm755 bin/9du                      %{buildroot}%{_bindir}/9du
install -Dm755 bin/9echo                    %{buildroot}%{_bindir}/9echo
install -Dm755 bin/9ed                      %{buildroot}%{_bindir}/9ed
install -Dm755 bin/9factor                  %{buildroot}%{_bindir}/9factor
...
install -Dm755 bin/9pr                      %{buildroot}%{_bindir}/9pr
...
install -Dm755 bin/9split                   %{buildroot}%{_bindir}/9split
install -Dm755 bin/srv                      %{buildroot}%{_bindir}/srv
install -Dm755 bin/9strings                 %{buildroot}%{_bindir}/9strings
install -Dm755 bin/9sum                     %{buildroot}%{_bindir}/9sum
...
install -Dm755 bin/9passwd                  %{buildroot}%{_bindir}/9passwd
...
install -Dm755 bin/9eqn                     %{buildroot}%{_bindir}/9eqn
...
install -Dm755 bin/9pic                     %{buildroot}%{_bindir}/9pic
...
install -Dm755 bin/9tbl                     %{buildroot}%{_bindir}/9tbl
install -Dm755 bin/tcs                      %{buildroot}%{_bindir}/tcs
install -Dm755 bin/tpic                     %{buildroot}%{_bindir}/tpic
install -Dm755 bin/9troff                   %{buildroot}%{_bindir}/9troff
