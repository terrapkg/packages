...
BuildRequires:  pkgconfig(egl) pkgconfig(glfw3) pkgconfig(freetype2) pkgconfig(dbus-1) pkgconfig(libunwind) pkgconfig(libdebuginfod) pkgconfig(tbb) pkgconfig(wayland-client) pkgconfig(wayland-protocols) pkgconfig(xkbcommon) %dnl pkgconfig(capstone)
...
do
    pushd $project
    %cmake -DDOWNLOAD_CAPSTONE=1 -DCMAKE_CXX_STANDARD=17 \
