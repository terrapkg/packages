...
Source3:		enable-kwin-system76-scheduler-integration.service
...
install -Dm644 %SOURCE3 %buildroot%_userunitdir/enable-kwin-system76-scheduler-integration.service
...
%systemd_user_post enable-kwin-system76-scheduler-integration


%preun
%systemd_user_preun com.system76.Scheduler.dbusproxy.service
%systemd_user_preun enable-kwin-system76-scheduler-integration
