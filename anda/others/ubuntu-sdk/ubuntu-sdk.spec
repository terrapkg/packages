...
ln -s %{buildroot}%{_datadir}/click/frameworks/ubuntu-sdk-20.04.framework %{buildroot}%{_datadir}/click/frameworks/current
ln -s %{buildroot}%{_datadir}/ubports/changelogs/20.04 %{buildroot}%{_datadir}/ubports/changelogs/current
