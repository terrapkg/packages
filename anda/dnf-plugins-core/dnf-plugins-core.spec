...
Provides:       dnf-plugins-extras-debug = %{epoch}:%{version}-%{release}
Provides:       dnf-plugins-extras-repoclosure = %{epoch}:%{version}-%{release}
Provides:       dnf-plugins-extras-repograph = %{epoch}:%{version}-%{release}
Provides:       dnf-plugins-extras-repomanage = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-builddep = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-config-manager = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-debuginfo-install = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-download = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-generate_completion_cache = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-needs_restarting = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-groups-manager = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-repoclosure = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-repodiff = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-repograph = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-repomanage = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-reposync = %{epoch}:%{version}-%{release}
%if %{with yumcompatibility}
Provides:       yum-plugin-copr = %{epoch}:%{version}-%{release}
Provides:       yum-plugin-changelog = %{epoch}:%{version}-%{release}
Provides:       yum-plugin-auto-update-debug-info = %{epoch}:%{version}-%{release}
%endif
...
%endif
Provides:       python2-dnf-plugins-extras-debug = %{epoch}:%{version}-%{release}
Provides:       python2-dnf-plugins-extras-repoclosure = %{epoch}:%{version}-%{release}
Provides:       python2-dnf-plugins-extras-repograph = %{epoch}:%{version}-%{release}
Provides:       python2-dnf-plugins-extras-repomanage = %{epoch}:%{version}-%{release}
...
Conflicts:      python3-%{name} < %{epoch}:%{version}-%{release}
Conflicts:      python-%{name} < %{epoch}:%{version}-%{release}
...
Provides:       python3-dnf-plugins-extras-debug = %{epoch}:%{version}-%{release}
Provides:       python3-dnf-plugins-extras-repoclosure = %{epoch}:%{version}-%{release}
Provides:       python3-dnf-plugins-extras-repograph = %{epoch}:%{version}-%{release}
Provides:       python3-dnf-plugins-extras-repomanage = %{epoch}:%{version}-%{release}
...
Conflicts:      %{name} <= 0.1.5
# let the both python plugin versions be updated simultaneously
Conflicts:      python2-%{name} < %{epoch}:%{version}-%{release}
Conflicts:      python-%{name} < %{epoch}:%{version}-%{release}
...
%if 0%{?rhel} != 7
Provides:       yum-utils = %{epoch}:%{version}-%{release}
%endif
%else
Provides:       dnf-utils = %{epoch}:%{version}-%{release}
Obsoletes:      dnf-utils < %{epoch}:%{version}-%{release}
%endif
...
Requires:       python2-%{name} = %{epoch}:%{version}-%{release}
Provides:       python2-dnf-plugins-extras-leaves = %{epoch}:%{version}-%{release}
%if !%{with python3}
Provides:       dnf-command(leaves)
Provides:       dnf-plugin-leaves = %{epoch}:%{version}-%{release}
Provides:       dnf-plugins-extras-leaves = %{epoch}:%{version}-%{release}
%endif
Conflicts:      dnf-plugins-extras-common-data < %{dnf_plugins_extra}
Conflicts:      python3-dnf-plugin-leaves < %{epoch}:%{version}-%{release}
...
Summary:        Leaves Plugin for DNF
Requires:       python3-%{name} = %{epoch}:%{version}-%{release}
Provides:       python3-dnf-plugins-extras-leaves = %{epoch}:%{version}-%{release}
Provides:       dnf-command(leaves)
Provides:       dnf-plugin-leaves = %{epoch}:%{version}-%{release}
Provides:       dnf-plugins-extras-leaves = %{epoch}:%{version}-%{release}
Conflicts:      dnf-plugins-extras-common-data < %{dnf_plugins_extra}
Conflicts:      python2-dnf-plugin-leaves < %{epoch}:%{version}-%{release}
...
Requires:       python2-%{name} = %{epoch}:%{version}-%{release}
%if !%{with python3}
Provides:       dnf-plugin-local =  %{epoch}:%{version}-%{release}
Provides:       dnf-plugins-extras-local = %{epoch}:%{version}-%{release}
%endif
Provides:       python2-dnf-plugins-extras-local = %{epoch}:%{version}-%{release}
Conflicts:      dnf-plugins-extras-common-data < %{dnf_plugins_extra}
Conflicts:      python3-dnf-plugin-local < %{epoch}:%{version}-%{release}
...
Requires:       python3-%{name} = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-local =  %{epoch}:%{version}-%{release}
Provides:       python3-dnf-plugins-extras-local = %{epoch}:%{version}-%{release}
Provides:       dnf-plugins-extras-local = %{epoch}:%{version}-%{release}
Conflicts:      dnf-plugins-extras-common-data < %{dnf_plugins_extra}
Conflicts:      python2-dnf-plugin-local < %{epoch}:%{version}-%{release}
...
Requires:       python2-%{name} = %{epoch}:%{version}-%{release}
Requires:       yum
Provides:       dnf-plugin-migrate = %{epoch}:%{version}-%{release}
Provides:       python2-dnf-plugins-extras-migrate = %{epoch}:%{version}-%{release}
Provides:       dnf-command(migrate)
Provides:       dnf-plugins-extras-migrate = %{epoch}:%{version}-%{release}
Conflicts:      dnf-plugins-extras-common-data < %{dnf_plugins_extra}
...
Requires:       python2-%{name} = %{epoch}:%{version}-%{release}
%if !%{with python3}
Provides:       dnf-plugin-post-transaction-actions =  %{epoch}:%{version}-%{release}
%endif
Conflicts:      python3-dnf-plugin-post-transaction-actions < %{epoch}:%{version}-%{release}
...
Requires:       python3-%{name} = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-post-transaction-actions =  %{epoch}:%{version}-%{release}
Conflicts:      python2-dnf-plugin-post-transaction-actions < %{epoch}:%{version}-%{release}
...
Summary:        Leaves Plugin for DNF
Requires:       python2-%{name} = %{epoch}:%{version}-%{release}
Requires:       python2-dnf-plugin-leaves = %{epoch}:%{version}-%{release}
%if !%{with python3}
Provides:       dnf-plugin-show-leaves =  %{epoch}:%{version}-%{release}
Provides:       dnf-command(show-leaves)
Provides:       dnf-plugins-extras-show-leaves = %{epoch}:%{version}-%{release}
%endif
Provides:       python2-dnf-plugins-extras-show-leaves = %{epoch}:%{version}-%{release}
Conflicts:      dnf-plugins-extras-common-data < %{dnf_plugins_extra}
Conflicts:      python3-dnf-plugin-show-leaves < %{epoch}:%{version}-%{release}
...
Requires:       python3-%{name} = %{epoch}:%{version}-%{release}
Requires:       python3-dnf-plugin-leaves = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-show-leaves =  %{epoch}:%{version}-%{release}
Provides:       python3-dnf-plugins-extras-show-leaves = %{epoch}:%{version}-%{release}
Provides:       dnf-command(show-leaves)
Provides:       dnf-plugins-extras-show-leaves = %{epoch}:%{version}-%{release}
Conflicts:      dnf-plugins-extras-common-data < %{dnf_plugins_extra}
Conflicts:      python2-dnf-plugin-show-leaves < %{epoch}:%{version}-%{release}
...
Requires:       python2-%{name} = %{epoch}:%{version}-%{release}
%if !%{with python3}
Provides:       dnf-plugin-versionlock =  %{epoch}:%{version}-%{release}
Provides:       dnf-command(versionlock)
Provides:       dnf-plugins-extras-versionlock = %{epoch}:%{version}-%{release}
%if %{with yumcompatibility}
Provides:       yum-plugin-versionlock = %{epoch}:%{version}-%{release}
%endif
%endif
Provides:       python2-dnf-plugins-extras-versionlock = %{epoch}:%{version}-%{release}
Conflicts:      dnf-plugins-extras-common-data < %{dnf_plugins_extra}
Conflicts:      python3-dnf-plugin-versionlock < %{epoch}:%{version}-%{release}
...
Requires:       python3-%{name} = %{epoch}:%{version}-%{release}
Provides:       dnf-plugin-versionlock =  %{epoch}:%{version}-%{release}
Provides:       python3-dnf-plugins-extras-versionlock = %{epoch}:%{version}-%{release}
Provides:       dnf-command(versionlock)
%if %{with yumcompatibility}
Provides:       yum-plugin-versionlock = %{epoch}:%{version}-%{release}
%endif
Provides:       dnf-plugins-extras-versionlock = %{epoch}:%{version}-%{release}
Conflicts:      dnf-plugins-extras-common-data < %{dnf_plugins_extra}
Conflicts:      python2-dnf-plugin-versionlock < %{epoch}:%{version}-%{release}
...
Provides:       dnf-plugin-modulesync =  %{epoch}:%{version}-%{release}
