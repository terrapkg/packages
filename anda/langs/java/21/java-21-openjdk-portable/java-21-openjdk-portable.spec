...
# Override the ccache mock plugin used in Terra, as it is not compatible with this package
%global __cc /usr/bin/gcc
%global __cxx /usr/bin/g++
%global __cpp /usr/bin/gcc -E
...
%global oj_vendor Terra
%global oj_vendor_url https://terrapkg.com/
# Define what url should JVM offer in case of a crash report
# order may be important, epel may have rhel declared
%if 0%{?epel}
%global oj_vendor_bug_url  https://github.com/terrapkg/packages/issues
%else
%if 0%{?fedora}
...
%endif
%endif
%global oj_vendor_version (Terra-%{version}-%{rpmrelease})
