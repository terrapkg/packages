...
Version:        0.7
Release:        1%{?dist}
Summary:        Two monoids as one, in holy haskimony

License:        BSD-3-Clause
URL:            https://hackage.haskell.org/package/semirings
...
More formally, a Semiring R is a set equipped with two binary relations `+` and
`*`, such that:
...
%changelog
* Thu Sep 17 2026 Owen Zimmerman <owen@fyralabs.com> - 0.7-1
- Initial commit
