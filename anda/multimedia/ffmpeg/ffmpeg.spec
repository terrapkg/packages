...
# HandBrake patches
Patch3:         ffmpeg-svt-vp9.patch
Patch4:         ffmpeg-HandBrake.patch

# https://code.ffmpeg.org/FFmpeg/FFmpeg/issues/23211
Patch5:         ffmpeg-vapoursynth-script-soname.patch
...
Requires:       libswscale%{?pkg_suffix}%{_isa} = %{eve}
