...
sed -i 's!prefix=!prefix=%{_prefix}!' %{_libdir}/pkgconfig/unity-core-6.0.pc
sed -i 's!exec_prefix=libexec!exec_prefix=%{_prefix}!' %{_libdir}/pkgconfig/unity-core-6.0.pc
sed -i 's!libdir=%{_lib}!libdir=%{_libdir}!' %{_libdir}/pkgconfig/unity-core-6.0.pc
sed -i 's!includedir=include!includedir=%{_prefix}/include!' %{_libdir}/pkgconfig/unity-core-6.0.pc
