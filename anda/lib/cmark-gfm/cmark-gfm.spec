...
%changelog
* Sun Jul 19 2026 Olivia <git@olivia.sh> - 0.29.0.gfm.13-3
- Update packager

* Thu Dec 25 2025 Olivia <git@olivia.sh> - 0.29.0.gfm.13-2
- Fix cmake install directories

* Wed Dec 24 2025 Olivia <git@olivia.sh> - 0.29.0.gfm.13-1
- Package cmark-gfm
