...
Release: 1%{?dist}
License: curl
Source0: https://curl.se/download/%{upstream_name}-%{version_no_tilde}.tar.xz
Source1: https://curl.se/download/%{upstream_name}-%{version_no_tilde}.tar.xz.asc
...
%autosetup -n %{upstream_name}-%{version_no_tilde} -p1
...
- create terra-curl with zstd compression support re-enabled
