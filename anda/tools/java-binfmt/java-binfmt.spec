...
echo ':ExecutableJAR:E::jar::/usr/bin/jarwrapper:' > %{buildroot}%{_sysconfdir}/binfmt.d/ExecutableJAR.conf
...
install -Dpm755 jarwrapper %{buildroot}%{_bindir}/jarwrapper

echo ':Java:M::\xca\xfe\xba\xbe::/usr/bin/javawrapper:' > %{buildroot}%{_sysconfdir}/binfmt.d/Java.conf
...
install -Dpm755 javawrapper %{buildroot}%{_bindir}/javawrapper

echo ':Applet:E::html::/opt/java/bin/appletviewer:' > %{buildroot}%{_sysconfdir}/binfmt.d/Applet.conf

%files -n java-jarwrapper
%{_sysconfdir}/binfmt.d/ExecutableJAR.conf
%{_bindir}/jarwrapper

%files -n java-javawrapper
%{_sysconfdir}/binfmt.d/Java.conf
%{_bindir}/javawrapper
...
%{_sysconfdir}/binfmt.d/Applet.conf
